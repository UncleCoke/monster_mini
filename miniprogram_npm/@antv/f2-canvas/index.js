    ...
    init: function init(callback) {
      ...
      query.select('.f2-canvas').boundingClientRect(function (res) {
        if (typeof callback === 'function') {
          _this.chart = callback(canvas, res.width, res.height, _wxF2.default,_this.data.chartData);
        } else if (_this.data.opts && _this.data.opts.onInit) {
          _this.chart = _this.data.opts.onInit(canvas, res.width, res.height, _wxF2.default,_this.data.chartData);
        }
      }).exec();
    },
